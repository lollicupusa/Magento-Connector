...
namespace NetSuiteConnector
{
    public class SuiteTalkConnector
    {
        ...
        public SalesOrder GetSalesOrder(string externalId)
        {
            ...
            {
                Console.WriteLine("Get Sales Order {0} failed!!", externalId);
                return null;
            }

            Console.WriteLine("Get Sales Order {0} Success!!", externalId);

            return (SalesOrder)response.record;
        }
        ...
        public List<ReadResponse> GetItems(List<RecordRef> recordRefs)
        {
            ...
            foreach (RecordRef recordRef in recordRefs)
            {
                ...
                ReadResponse readResponse = GetRecord(recordRef);
